...
def make_log_dir_name(cfg):
    ...
    extra = cfg.scratch.extra
    log_dir_name = f'size-{model_type}_subset-{subset}_frames-{num_frames}_baselr-{base_lr}_visionlr-{vision_lr}_anno-{anno_type}_affine-{degrees}-{shear}_multi-{multislice}_lora-{lora}-{lora_rank}_num-ortho-{num_ortho}_no_temp_{extra}'
